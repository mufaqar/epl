...
class Options_Machine {
	...
	public static function optionsframework_media_uploader_function($id,$std,$mod){
		...
		if ( function_exists( 'wp_enqueue_media' ) ) {
			...
			$uploader .= '<span class="button remove-image '. $hide.'" id="reset_'. $id .'" title="' . $id . '">Remove</span><div style="clear:both;"></div>';
		}
		else 
		{
		...
		if(!empty($upload)){	
	    	...
	    	$uploader .= '<img class="'.$hide.' of-option-image" id="image_'.$id.'" src="'.$upload.'" alt="" />';
	    	$uploader .= '</a>';			
			}
		$uploader .= '</div>';
	...
	public static function optionsframework_slider_function($id,$std,$oldorder,$order){
		...
		$slider .= '<span class="button remove-image '. $hide.'" id="reset_'. $id .'_'.$order .'" title="' . $id . '_'.$order .'">Remove</span><div style="clear:both;"></div>';
		$slider .='</div>' . "\n";
